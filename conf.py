...
BLOG_AUTHOR = "James Mitchell"  # (translatable)
BLOG_TITLE = "James Mitchell"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://jamesmitchellweb.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://jamesmitchellweb.com/"
BLOG_EMAIL = "james.alexander.mitchell@cern.ch"
BLOG_DESCRIPTION = "The purpose of this website is to provide an area for information about myself.  Additionally, it acts as a means of cataloguing documentation and projects for which I am involved or interested in."  # (translatable)
...
# Commented out to remove the blog
#### Blog
#        (
#            (
#                ("/posts/", "Latest"),
